	...
	theme: {
		...
		extend: {
			...
			backgroundImage: {
				...
				'grid-pattern': 'linear-gradient(to right, hsla(var(--foreground), 0.1) 1px, transparent 1px), linear-gradient(to bottom, hsla(var(--foreground), 0.1) 1px, transparent 1px)',
